...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public static void reflectLayoutManager(Banner banner) {
        ...
        try {
            ...
            String $2 = "mLayoutManager";
            if (obj != null) {
                Field declaredField3 = obj.getClass().getDeclaredField($2);
            ...
            if (obj2 != null) {
                Field declaredField5 = obj2.getClass().getDeclaredField($2);
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.b0 b0Var, int i5) {
        q qVar = new q(recyclerView.getContext()) { // from class: com.youth.banner.util.ScrollSpeedManger.1
            @Override // androidx.recyclerview.widget.q
            protected int calculateTimeForDeceleration(int i6) {
