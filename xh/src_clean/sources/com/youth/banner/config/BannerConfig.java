...
public class BannerConfig {
    ...
    public static final int INDICATOR_NORMAL_WIDTH = (int) BannerUtils.dp2px(5.0f);
    public static final int INDICATOR_SELECTED_WIDTH = (int) BannerUtils.dp2px(7.0f);
    public static final int INDICATOR_SPACE = (int) BannerUtils.dp2px(5.0f);
