...
| **阶段 E (E0-E3)** | 商业产品 V1.0 - 门禁/隔离/客户端/生产安全 | [`COMMERCIAL_V1_PLAN.md`](./docs/COMMERCIAL_V1_PLAN.md) | ✅ E0-E3 完成（发布门禁、隔离、客户端闭环与生产安全阻断就绪） |
...
| 切片 | 内容 | 状态 |
|------|------|------|
| **E0** | 发布门禁与履约质量（双平台 e2e 门禁） | ✅ 完成 |
| **E1** | 多用户 Job/文件隔离 | ✅ 完成 |
| **E2** | 客户端登录/兑卡/VIP 闭环 | ✅ 完成 |
| **E3** | 生产安全默认（禁默认密钥上公网） | ✅ 完成 |
| **E4** | 最小运营（封禁/废卡批次） | ✅ 完成 |
| **E5** | 可观测性与备份 | ✅ 完成 |
| **E6** | 正式发行与 `v1.0.0` 清单 | ✅ 完成 |
